...
TEST(CompressingDecompressingFile, compressingDecompressingFile1)
{
    ...
    std::string out;
    const std::string sequence = "";
    TestCompressor cmpr;
    cmpr.setOstream(of);
...
TEST(CompressingDecompressingFile, compressingDecompressingFile3)
{
    ...
    std::string out;
    const std::string sequence = "ACNUACGACGAGGUGCAGUGAGCCGACACAGUGCCUACGACAACACUAACUAGCCUGGGCAUACGACUACGACN";
    TestCompressor cmpr;
    cmpr.setOstream(of);
